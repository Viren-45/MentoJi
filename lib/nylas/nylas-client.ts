...
export const createAuthUrl = (provider: string, expertId: string) => {
  ...
  console.log("Creating auth URL with redirect URI:", redirectUri); // Debug log
  ...
  const params = new URLSearchParams({
    ...
    state: JSON.stringify({ provider, expertId }), // Include expert ID in state
    provider: provider,
  });
...
// Helper function to exchange code for grant
...
// Helper function to revoke grant
