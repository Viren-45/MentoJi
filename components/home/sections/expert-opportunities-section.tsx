// components/home/sections/expert-opportunities-section.tsx
"use client";

import React from "react";
import { Clock, DollarSign, Video, FileText, Sparkles } from "lucide-react";
...
const ExpertOpportunitiesSection: React.FC = () => {
  const opportunities = [
    ...
    },
    {
      ...
      description:
        "Clients come prepared with context, maximizing session value",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Join the future of professional consulting. Share your knowledge
            through focused micro-sessions and build a flexible income stream on
            your terms.
          </p>
        </div>
