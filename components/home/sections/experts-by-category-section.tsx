// components/home/sections/experts-by-category-section.tsx
"use client";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Discover the types of professionals available on MentoJi — ready
            to offer focused advice when you need it most.
            <span className="text-blue-600 font-medium">
              {" "}
              New experts are joining every day.
            </span>
          </p>
        </div>
