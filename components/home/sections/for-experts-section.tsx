// components/home/sections/for-experts-section.tsx
"use client";
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight">
                <span className="text-gray-900">Turn your expertise</span>
                <br />
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
                Share your knowledge through quick consultations and build a
                flexible income stream. Set your rates, choose your schedule,
                work from anywhere.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
                  variant="gradient"
                  className="font-semibold hover:scale-[1.03]"
                >
                  Start Earning Today
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="border-blue-600 border-2 text-blue-600 hover:text-blue-600 hover:bg-blue-50"
                >
                  See How It Works
                </Button>
              </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Get rated by clients and showcase your expertise to
                ...
                <div className="max-w-sm bg-white/90 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-white/50 transform -rotate-1 hover:rotate-0 transition-transform duration-300">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Reach clients worldwide through our platform's video
                        consultation system.
                      </p>
                    </div>
                  </div>
                ...
                <div className="ml-auto max-w-sm bg-white/90 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-white/50 transform rotate-1 hover:rotate-0 transition-transform duration-300">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Scale from side hustle to full-time income as you build
                        your client base.
                      </p>
                    </div>
                  </div>
