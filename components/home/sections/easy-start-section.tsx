            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Browse expert profiles, check ratings, and preview
                    consultation types — all for free.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    No contracts, no emails back and forth. Just tell us what
                    you need, and we'll match you instantly.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    15–30 minute video calls with vetted professionals — from
                    marketing to legal, product, finance, and more.
                  </p>
                </div>
              </div>
            </div>
