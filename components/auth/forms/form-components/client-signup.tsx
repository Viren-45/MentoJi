// components/auth/forms/form-components/client-signup.tsx
"use client";
...
const ClientSignup = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {/* Navigation Links */}
      <div className="text-center text-base text-gray-600 space-y-2 pt-4">
        <p>
        ...
        <p>
          Looking to join us as an expert?{" "}
          <Link
            href="/expert"
            className="text-blue-600 hover:text-blue-700 hover:underline font-medium"
          >
